...
public class Ques_6 extends AppCompatActivity {


    Button btn_yes_6,btn_no_6;
    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_ques_6);

        btn_yes_6 = findViewById(R.id.btn_yes_6);
        btn_no_6 = findViewById(R.id.btn_no_6);


        btn_yes_6.setOnClickListener(new View.OnClickListener() {
            @Override
        ...
        btn_no_6.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
