...
public class Ques_4 extends AppCompatActivity {

    Button btn_yes_4,btn_no_4;
    @Override
    protected void onCreate(Bundle savedInstanceState) {
        ...
        btn_yes_4 = findViewById(R.id.btn_yes_4);
        btn_no_4 = findViewById(R.id.btn_no_4);


        btn_yes_4.setOnClickListener(new View.OnClickListener() {
            @Override
        ...
        btn_no_4.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
